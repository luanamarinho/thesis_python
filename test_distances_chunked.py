...
#k = [30, 300]
#dist_embedded = pairwise_distances(mds_transformed)
#t = trustworthiness_chunks_multik(dist_X=dist_X, dist_embedded=dist_embedded, k = k)
#stress = shepard_stress_chunk(dist_X=dist_X, dist_embedded=dist_embedded) #
...
#for chunk in pairwise_distances_chunked(data_tsne, reduce_func=reduce_func, n_jobs=-1, working_memory=64):
  #print(len(chunk)
...
#stress = np.sqrt(sum_num_denom[0] / sum_num_denom[1]) #0.40459501846416124
#sum_numerator = sum_num_denom[0] #434479.06333569647
#trust # array([0.58640971, 0.65650149])
