...
def main():
    try:
        ...
        #ind = slice(88,133)
        combination_BH_run = combination_BH[105:150]
        ...
        result_file_path = 'output/pipeline_multiples_perp45_105-150.joblib'
